...
export function V5Preview({ styles }: PreviewProps) {
  ...
  const collapsed = [previewData.categories[1], previewData.categories[2], previewData.categories[3]];
    ...
    <div className="min-h-full" style={{ backgroundColor: "#ffffff", color: "#111827", fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <div className="px-3 pt-2.5 pb-2">
        <div className="flex items-center gap-1">
          <h1 className="text-[14px] font-extrabold leading-none tracking-tight text-gray-900">{previewData.storeName}</h1>
