...
export function DeliverySettings() {
    ...
    useEffect(() => {
        if (userData?.role === "partner") {
            ...
            setDeliveryRules({
                ...
                porter_free_km: userData.delivery_rules?.porter_free_km ?? 0,
                free_delivery_enabled: userData.delivery_rules?.free_delivery_enabled ?? false,
                free_delivery_min_order: userData.delivery_rules?.free_delivery_min_order ?? 0,
                free_delivery_max_km: userData.delivery_rules?.free_delivery_max_km ?? 0,
                free_delivery_mode: userData.delivery_rules?.free_delivery_mode || "free",
                free_delivery_discount: userData.delivery_rules?.free_delivery_discount ?? 0,
                free_delivery_any_distance: userData.delivery_rules?.free_delivery_any_distance ?? false,
            });
    ...
    useEffect(() => {
        ...
        const initialRules = {
            ...
            free_delivery_enabled: data.delivery_rules?.free_delivery_enabled ?? false,
            free_delivery_min_order: data.delivery_rules?.free_delivery_min_order ?? 0,
            free_delivery_max_km: data.delivery_rules?.free_delivery_max_km ?? 0,
            free_delivery_mode: data.delivery_rules?.free_delivery_mode || "free",
            free_delivery_discount: data.delivery_rules?.free_delivery_discount ?? 0,
            free_delivery_any_distance: data.delivery_rules?.free_delivery_any_distance ?? false,
            porter_free_km: data.delivery_rules?.porter_free_km ?? 0,
        };
