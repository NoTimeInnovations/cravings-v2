...
interface AdminV2PurchaseListProps {
    purchases: PartnerPurchase[];
}

// Mobile Card View Component
const AdminV2PurchaseCard = ({ purchase }: { purchase: PartnerPurchase }) => (
...
export const AdminV2PurchaseList = ({ purchases }: AdminV2PurchaseListProps) => {
        ...
        <>
            ...
            <div className="md:hidden space-y-4">
                {purchases.map((purchase) => (
                    <AdminV2PurchaseCard key={purchase.id} purchase={purchase} />
                ))}
            </div>
