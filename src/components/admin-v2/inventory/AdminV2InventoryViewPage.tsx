...
export const AdminV2InventoryViewPage = () => {
                            ...
                            <TableBody>
                                {inventory.map((item) => (
                                    <TableRow key={item.id}>
                                        ...
                                        <TableCell className="text-right text-red-500">{item.totalUsage.toLocaleString('en-IN')}</TableCell>
                                        <TableCell className="text-right text-blue-500">{item.balanceQuantity.toLocaleString('en-IN')}</TableCell>
                                        <TableCell className="text-right text-green-500">{formatCurrency(item.purchaseAmount)}</TableCell>
                                        <TableCell className="text-right text-red-500">{formatCurrency(item.usageAmount)}</TableCell>
                                        <TableCell className="text-right text-blue-500">{formatCurrency(item.balanceAmount)}</TableCell>
                        ...
                        {inventory.map((item) => (
                            <Card key={item.id}>
                                ...
                                <CardContent className="space-y-2 text-sm">
                                    <div className="flex justify-between"><span>Balance Qty:</span><span className="font-semibold text-blue-500">{item.balanceQuantity.toLocaleString('en-IN')}</span></div>
                                    <div className="flex justify-between"><span>Balance Amt:</span><span className="font-semibold text-blue-500">{formatCurrency(item.balanceAmount)}</span></div>
                                    ...
                                    <div className="flex justify-between"><span>Usage Qty:</span><span className="font-semibold text-red-500">{item.totalUsage.toLocaleString('en-IN')}</span></div>
                                    <div className="flex justify-between"><span>Purchase Amt:</span><span className="font-semibold text-green-500">{formatCurrency(item.purchaseAmount)}</span></div>
                                    <div className="flex justify-between"><span>Usage Amt:</span><span className="font-semibold text-red-500">{formatCurrency(item.usageAmount)}</span></div>
