...
export const UpgradeEmail = ({
  ...
  <Html>
    <Head />
    <Preview>
      Your plan has been upgraded! Enjoy your new features on Menuthere.
    </Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Text style={text}>
            Great news! Your account on <strong>Menuthere</strong> has been
            successfully upgraded to the{" "}
            <span style={highlight}>{newPlanName}</span>.
          </Text>
