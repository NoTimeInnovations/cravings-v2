...
const SETTINGS_ENTRIES: SearchEntry[] = [
  ...
  { label: "Delivery bridge", crumb: "Settings › Ordering › Delivery bridge", view: "Settings", sg: "ordering", ss: "bridge" },
  { label: "Vehicle", crumb: "Settings › Ordering › Delivery bridge", view: "Settings", sg: "ordering", ss: "bridge" },
  { label: "Search each provider for", crumb: "Settings › Ordering › Delivery bridge", view: "Settings", sg: "ordering", ss: "bridge" },
  { label: "Book a rider automatically", crumb: "Settings › Ordering › Delivery bridge", view: "Settings", sg: "ordering", ss: "bridge" },
  { label: "Book when the order is", crumb: "Settings › Ordering › Delivery bridge", view: "Settings", sg: "ordering", ss: "bridge" },
  { label: "After", crumb: "Settings › Ordering › Delivery bridge", view: "Settings", sg: "ordering", ss: "bridge" },
  { label: "What the customer pays for delivery", crumb: "Settings › Ordering › Delivery bridge", view: "Settings", sg: "ordering", ss: "bridge" },
  { label: "Provider order", crumb: "Settings › Ordering › Delivery bridge", view: "Settings", sg: "ordering", ss: "bridge" },
  { label: "Move up", crumb: "Settings › Ordering › Delivery bridge", view: "Settings", sg: "ordering", ss: "bridge" },
  { label: "Move down", crumb: "Settings › Ordering › Delivery bridge", view: "Settings", sg: "ordering", ss: "bridge" },
  ...
  { label: "Print the bill automatically", crumb: "Settings › Printing › Layout", view: "Settings", sg: "printing", ss: "layout" },
  { label: "Print when the order becomes", crumb: "Settings › Printing › Layout", view: "Settings", sg: "printing", ss: "layout" },
  ...
  { label: "Delivery bridge", crumb: "Settings › Ordering", view: "Settings", sg: "ordering", ss: "bridge" }
];
...
const EXTRA_ENTRIES: SearchEntry[] = [
  ...
  { label: "Accounts", crumb: "Settings › Ordering › Delivery bridge", view: "Settings", sg: "ordering", ss: "bridge" },
  { label: "Porter", crumb: "Settings › Ordering › Delivery bridge", view: "Settings", sg: "ordering", ss: "bridge" },
  { label: "Rapido", crumb: "Settings › Ordering › Delivery bridge", view: "Settings", sg: "ordering", ss: "bridge" },
  { label: "Online payment", crumb: "Settings › Payments & tax › Methods", view: "Settings", sg: "payments", ss: "methods" },
