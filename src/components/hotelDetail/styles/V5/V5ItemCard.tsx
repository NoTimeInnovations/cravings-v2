...
// The compact cross-sell card ("you will love pairing it with") now lives in a
// shared component and is rendered via <PairingRecommendations>, so it is reused
// identically across every storefront layout.
