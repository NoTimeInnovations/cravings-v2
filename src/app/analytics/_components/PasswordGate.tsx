      ...
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-sm border border-neutral-200 p-6">
        ...
        <form action={authenticateAnalytics} className="mt-5 space-y-3">
          <input
            ...
            className="w-full rounded-lg border border-neutral-300 bg-white text-neutral-900 placeholder:text-neutral-400 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-neutral-900"
          />
          {error && (
