        ...
        {animatedDriver && (
          ...
          >
            ...
            >
              ...
              >
                <path
                  d="M78.13 93.36c0-4.17 3.38-7.55 7.55-7.55h22.66c4.17 0 7.55 3.38 7.55 7.55 0 4.17-3.38 7.55-7.55 7.55H85.68c-4.17 0-7.55-3.38-7.55-7.55z"
                  fill="white"
                />
                <path
                  d="M146.11 83.87C146.11 80.07 149.18 77 152.97 77h18.54c6.83 0 12.36 5.53 12.36 12.36 0 1.52-1.23 2.75-2.75 2.75h-27.46c-4.17 0-7.55-3.38-7.55-7.55v-.69z"
                  fill="white"
                />
                <path
                  d="M152.55 151.9c0 5.21-4.23 9.44-9.44 9.44H63.17c-4.17 0-7.55-3.38-7.55-7.55s3.38-7.55 7.55-7.55h83.71c3.13 0 5.67 2.54 5.67 5.67z"
                  fill="white"
                />
                <circle cx="93.24" cy="161.34" r="22.66" fill="white" />
                <circle cx="183.87" cy="161.34" r="22.66" fill="white" />
                <circle cx="93.24" cy="161.34" r="7.55" fill="#FF8220" />
                <circle cx="183.87" cy="161.34" r="7.55" fill="#FF8220" />
              </svg>
            </div>
          </OverlayView>
        )}
