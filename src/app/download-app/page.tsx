                ...
                <div className="w-full sm:max-w-[90%] md:max-w-[80%] lg:max-w-[75%] mx-auto grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="text-center lg:text-left">
                        <h1 className="geist-font text-3xl sm:text-4xl md:text-[3.25rem] md:leading-[1.15] font-semibold text-stone-900 tracking-tight">
                            {t.downloadApp.heroHeadingLead}{" "}
                            <span className="text-stone-500">{t.downloadApp.heroHeadingHighlight}</span>
                        </h1>

                        <p className="geist-font text-lg text-stone-500 max-w-lg mx-auto lg:mx-0 mt-5 leading-relaxed">
                            {t.downloadApp.heroSubheading}
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start mt-8 flex-wrap">
                            ...
                            <Link href="#" className="inline-flex items-center gap-3 bg-stone-900 text-white px-5 py-3 rounded-full hover:bg-stone-800 transition-colors">
                                ...
                                <div className="flex flex-col items-start leading-none">
                                    <span className="text-[10px] uppercase font-medium text-stone-400 tracking-wider">{t.downloadApp.appStoreBadgePrefix}</span>
                            ...
                            <Link href="#" className="inline-flex items-center gap-3 bg-stone-900 text-white px-5 py-3 rounded-full hover:bg-stone-800 transition-colors">
                                ...
                                <div className="flex flex-col items-start leading-none ml-1">
                                    <span className="text-[10px] uppercase font-medium text-stone-400 tracking-wider">{t.downloadApp.playStoreBadgePrefix}</span>
                            ...
                            {windowsDownloadUrl && (
                                ...
                                >
                                    ...
                                    <div className="flex flex-col items-start leading-none">
                                        <span className="text-[10px] uppercase font-medium text-stone-400 tracking-wider">{t.downloadApp.windowsBadgePrefix}</span>
                                        <span className="text-base font-semibold">{t.downloadApp.windowsBadgePlatform}</span>
                                    </div>
                                </Link>
                            )}
                        </div>
                    ...
                    <div className="relative flex justify-center items-center">
                        <img
                            src="/hero-image.png"
                            alt={t.downloadApp.heroImageAlt}
                            width={1400}
                            height={1600}
