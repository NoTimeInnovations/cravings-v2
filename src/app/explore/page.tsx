...
export const metadata: Metadata = {
  title: "Explore Offers | Menuthere",
  description:
    "Discover amazing offers and deals from restaurants near you. Browse through exclusive discounts and promotions on Menuthere.",
