...
export async function generateMetadata(): Promise<Metadata> {
    ...
    return {
        title: `Manage Your Google Business Menu | ${config.name} `,
        ...
        openGraph: {
            ...
            type: "website",
            url: "https://www.cravings.live/solutions/google-business",
        },
    };
}
...
export default async function GoogleBusinessPage() {
    ...
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            },
            {
                ...
                item: "https://www.cravings.live/solutions/google-business",
            },
        ],
    };
    ...
    return (
        <main className="min-h-screen bg-[#f4e5d5] relative">
            ...
            {/* ═══════════════ STATS BAR ═══════════════ */}
            <section className="py-8 bg-gradient-to-r from-[#4285F4] via-[#3367D6] to-[#4285F4] relative">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {BENEFITS.map((benefit, idx) => (
                            ...
                            >
                                <div className="w-14 h-14 rounded-xl bg-blue-50 flex items-center justify-center mb-5 group-hover:bg-[#4285F4] group-hover:scale-110 transition-all duration-300">
                                    <benefit.icon className="w-7 h-7 text-[#4285F4] group-hover:text-white transition-colors duration-300" />
                                </div>
                                <h3 className="text-xl font-bold text-gray-900 mb-3">
                                    {benefit.title}
                                </h3>
            ...
            <section className="py-24 relative">
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        {/* CTA Box */}
                        <div className="bg-gradient-to-br from-[#4285F4] to-[#3367D6] rounded-2xl p-10 text-white shadow-2xl relative overflow-hidden">
                            {/* Decorative circles */}
                            ...
                            <div className="relative z-10">
                                ...
                                <Link
                                    href="/get-started"
                                    className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold bg-white text-[#4285F4] rounded-xl hover:bg-gray-50 transition-colors shadow-lg"
                                >
                                    Start Free Trial
            ...
            <section className="py-20 bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f3460] relative overflow-hidden">
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 relative z-10">
                    <div className="text-center mb-12">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-500/20 to-blue-500/20 backdrop-blur-sm border border-purple-400/20 rounded-full text-sm font-medium mb-5">
                            <Sparkles className="w-4 h-4 text-purple-300" />
                            <span className="bg-gradient-to-r from-purple-200 to-blue-200 bg-clip-text text-transparent">Coming Soon</span>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white/[0.04] backdrop-blur-sm rounded-2xl border border-white/10 p-6 hover:bg-white/[0.07] transition-all duration-300">
                            <div className="flex items-center gap-3 mb-4">
                                <div className="w-10 h-10 rounded-xl bg-purple-500/15 flex items-center justify-center">
                                    <Send className="w-5 h-5 text-purple-400" />
                                </div>
                                <h3 className="text-lg font-bold text-white">Auto-Post to Google</h3>
                            </div>
                        ...
                        <div className="bg-white/[0.04] backdrop-blur-sm rounded-2xl border border-white/10 p-6 hover:bg-white/[0.07] transition-all duration-300">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="text-lg font-bold text-white">AI Review Replies</h3>
                            </div>
                            <p className="text-gray-400 text-sm leading-relaxed mb-5">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        {[
                            ...
                            { slug: "owners", label: "Restaurant Owners", icon: BarChart3 },
                            {
                                slug: "petpooja",
                            ...
                            <Link
                                ...
                                className="inline-flex items-center gap-2 px-6 py-3 bg-white rounded-full hover:bg-gray-50 transition-colors border border-gray-200 hover:border-[#e65a22] hover:text-[#e65a22] group"
                            >
                                <link.icon className="w-5 h-5 text-gray-500 group-hover:text-[#e65a22] transition-colors" />
                                <span className="font-medium text-gray-900 group-hover:text-[#e65a22] transition-colors">
                                    {link.label}
                                </span>
                                <ChevronRight className="w-4 h-4 text-gray-400 group-hover:text-[#e65a22] transition-colors" />
                            </Link>
                        ))}
                    </div>
                </div>
