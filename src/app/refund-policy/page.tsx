            ...
            <div className="max-w-4xl mx-auto px-6">
                ...
                <div className="space-y-8 text-gray-700 leading-relaxed">
                    ...
                    <section>
                        ...
                        <p className="mb-2">
                            Email us at <a href="mailto:help@mail.menuthere.com" className="text-orange-600 hover:underline">help@mail.menuthere.com</a>
                        </p>
                    ...
                    <section>
                        ...
                        <p className="mt-2 font-medium">
                            📧 <a href="mailto:help@mail.menuthere.com" className="text-orange-600 hover:underline">help@mail.menuthere.com</a>
                        </p>
                    </section>
                </div>
            </div>
