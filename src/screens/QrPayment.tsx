      ...
      <div className="flex justify-between items-start">
        ...
        <div className="flex flex-col gap-2 flex-1">
          ...
          <div className="flex items-center gap-2">
            <img src="/menuthere-logo-new.png" alt="Menuthere" width={40} height={40} className="w-10 h-10 object-contain" />
                  ...
                  <div className="w-full flex flex-col gap-4">
                    <div className="flex flex-col gap-1">
                      ...
                      >
                        {hotelDetails ? (
                          <>
                            <img src="/menuthere-logo-new.png" alt="" width={16} height={16} className="w-4 h-4 object-contain" />
                            View Menu
                          </>
                        ) : null}
                      </Link>
